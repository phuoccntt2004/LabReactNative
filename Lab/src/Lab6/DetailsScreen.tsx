...
const DetailScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  return (
    <View style = {{flex: 1, marginHorizontal: 15, justifyContent: 'center'}}>
      <Text style = {{fontSize: 18, color: COLORS.BLUE, fontWeight: '500'}}>Xin Chào: {name}</Text>
      <Text style = {{fontSize: 18, color: COLORS.BLUE, fontWeight: '500', marginBottom: 40}}>Id của bạn là: {id}</Text>
